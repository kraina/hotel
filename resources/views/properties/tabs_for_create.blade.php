    ...
    <div class="row">
        <div class="col-2">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active" id="v-pills-basic1-tab" data-toggle="pill" href="#v-pills-basic1" role="tab" aria-controls="v-pills-basic" aria-selected="true">Basic Information</a>
                <a class="nav-link" id="v-pills-features1-tab" data-toggle="pill" href="#v-pills-features1" role="tab" aria-controls="v-pills-features" aria-selected="false">Additional Features</a>
                <a class="nav-link" id="v-pills-images1-tab" data-toggle="pill" href="#v-pills-images1" role="tab" aria-controls="v-pills-images" aria-selected="false">Images</a>
                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Settings</a>
            </div>
        </div>
        <div class="col-10">
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-basic1" role="tabpanel" aria-labelledby="v-pills-basic-tab">
            ...
            <div class="tab-pane fade" id="v-pills-images1" role="tabpanel" aria-labelledby="v-pills-images1-tab">
                Images
            </div>
